...
import { Node } from "../portfolioConstruction/types";
import {
  extendWithDeleteProperty,
  extendWithUpdateProperty,
} from "../portfolioConstruction/lib.ts";
import DroppableContainer from "../portfolioConstruction/draggable/DroppableContainerTP.tsx";

const OcioDestination: React.FC<{
  nodes: Node[];
  node: Partial<Node>;
...
export default OcioDestination;
